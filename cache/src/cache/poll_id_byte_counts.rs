...
pub struct PollIdByteCounts {
    LAST_MONTH: [u8; NUM_TIMEZONES_WITH_GLOBAL_CATEGORY],
    THIS_MONTH: [u8; NUM_TIMEZONES_WITH_GLOBAL_CATEGORY],
    NEXT_MONTH: [u8; NUM_TIMEZONES_WITH_GLOBAL_CATEGORY],
    LAST_WEEK: [u8; NUM_TIMEZONES_WITH_GLOBAL_CATEGORY],
    THIS_WEEK: [u8; NUM_TIMEZONES_WITH_GLOBAL_CATEGORY],
    NEXT_WEEK: [u8; NUM_TIMEZONES_WITH_GLOBAL_CATEGORY],
    DAY_B4_YESTERDAY: [u8; NUM_TIMEZONES_WITH_GLOBAL_CATEGORY],
    YESTERDAY: [u8; NUM_TIMEZONES_WITH_GLOBAL_CATEGORY],
    TODAY: [u8; NUM_TIMEZONES_WITH_GLOBAL_CATEGORY],
    TOMORROW: [u8; NUM_TIMEZONES_WITH_GLOBAL_CATEGORY],
    DAY_AFTER_TOMORROW: [u8; NUM_TIMEZONES_WITH_GLOBAL_CATEGORY],
}
