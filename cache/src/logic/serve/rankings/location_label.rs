...
pub fn get_todays_location_label_rankings_by_global_ids(
    vc_day_id: DayId,
    ...
    return get_location_label_rankings_by_global_ids(
        current_period_ids.todays_vc_day_id,
        vc_day_id,
        timezone_id,
        &cache.get_location_label_index_map().today,
...
pub fn get_todays_location_label_rankings_by_location_cache_index_and_global_label_ids(
    vc_day_id: DayId,
    timezone_id: TimezoneId,
    block_index: u32,
    ...
    return get_location_label_rankings_by_location_cache_index_and_global_label_id(
        current_period_ids.todays_vc_day_id,
        vc_day_id,
        timezone_id,
        &cache.get_location_label_index_map().today,
...
pub fn get_todays_location_label_rankings_by_cache_indexes(
    vc_day_id: DayId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
    location_label_cache_index: LocationLabelCacheIndex,
    cache: &Box<CacheReader + Send + Sync>,
) -> Vec<u8> {
    if timezone_id >= NUM_TIMEZONES {
        return codes::INVALID_TIMEZONE_ID_RESPONSE.to_vec();
    ...
    return get_location_label_rankings_by_cache_indexes(
        current_period_ids.todays_vc_day_id,
        vc_day_id,
        timezone_id,
        &cache.get_location_poll_rankings().today,
        location_cache_index,
        location_label_cache_index,
        block_index,
        cache.get_poll_id_byte_counts().today[timezone_id as usize],
    );
}

pub fn get_yesterdays_location_label_rankings_by_global_ids(
    vc_day_id: DayId,
    timezone_id: TimezoneId,
    block_index: u32,
    global_location_id: LocationId,
    ...
    return get_location_label_rankings_by_global_ids(
        ...
        vc_day_id,
        timezone_id,
        &cache.get_location_label_index_map().yesterday,
...
pub fn get_yesterdays_location_label_rankings_by_location_cache_index_and_global_label_ids(
    vc_day_id: DayId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
...
pub fn get_yesterdays_location_label_rankings_by_cache_indexes(
    vc_day_id: DayId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
...
pub fn get_day_b4_yesterdays_location_label_rankings_by_global_ids(
    vc_day_id: DayId,
    timezone_id: TimezoneId,
    block_index: u32,
    global_location_id: LocationId,
    ...
    return get_location_label_rankings_by_global_ids(
        ...
        vc_day_id,
        timezone_id,
        &cache.get_location_label_index_map().day_b4_yesterday,
...
pub fn get_day_b4_yesterdays_location_label_rankings_by_location_cache_index_and_global_label_ids(
    vc_day_id: DayId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
...
pub fn get_day_b4_yesterdays_location_label_rankings_by_cache_indexes(
    vc_day_id: DayId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
...
pub fn get_this_weeks_location_label_rankings_by_global_ids(
    vc_week_id: WeekId,
    timezone_id: TimezoneId,
    block_index: u32,
    global_location_id: LocationId,
    ...
    return get_location_label_rankings_by_global_ids(
        ...
        vc_week_id,
        timezone_id,
        &cache.get_location_label_index_map().this_week,
...
pub fn get_this_weeks_location_label_rankings_by_location_cache_index_and_global_label_ids(
    vc_week_id: WeekId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
...
pub fn get_this_weeks_location_label_rankings_by_cache_indexes(
    vc_week_id: WeekId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
...
pub fn get_last_weeks_location_label_rankings_by_global_ids(
    vc_week_id: WeekId,
    timezone_id: TimezoneId,
    block_index: u32,
    global_location_id: LocationId,
    ...
    return get_location_label_rankings_by_global_ids(
        ...
        vc_week_id,
        timezone_id,
        &cache.get_location_label_index_map().last_week,
...
pub fn get_last_weeks_location_label_rankings_by_location_cache_index_and_global_label_ids(
    vc_week_id: WeekId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
...
pub fn get_last_weeks_location_label_rankings_by_cache_indexes(
    vc_week_id: WeekId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
...
pub fn get_this_months_location_label_rankings_by_global_ids(
    vc_month_id: MonthId,
    timezone_id: TimezoneId,
    block_index: u32,
    global_location_id: LocationId,
    ...
    return get_location_label_rankings_by_global_ids(
        ...
        vc_month_id,
        timezone_id,
        &cache.get_location_label_index_map().this_month,
...
pub fn get_this_months_location_label_rankings_by_location_cache_index_and_global_label_ids(
    vc_month_id: MonthId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
...
pub fn get_this_months_location_label_rankings_by_cache_indexes(
    vc_month_id: MonthId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
    location_label_cache_index: u32,
    cache: &Box<CacheReader + Send + Sync>,
) -> Vec<u8> {
    if timezone_id >= NUM_TIMEZONES {
        return codes::INVALID_TIMEZONE_ID_RESPONSE.to_vec();
...
pub fn get_last_months_location_label_rankings_by_global_ids(
    vc_month_id: MonthId,
    timezone_id: TimezoneId,
    block_index: u32,
    global_location_id: LocationId,
    ...
    return get_location_label_rankings_by_global_ids(
        ...
        vc_month_id,
        timezone_id,
        &cache.get_location_label_index_map().last_month,
...
pub fn get_last_months_location_label_rankings_by_location_cache_index_and_global_label_ids(
    vc_month_id: MonthId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
...
pub fn get_last_months_location_label_rankings_by_cache_indexes(
    vc_month_id: MonthId,
    timezone_id: TimezoneId,
    block_index: u32,
    location_cache_index: LocationCacheIndex,
...
#[inline]
fn get_location_label_rankings_by_global_ids(
    current_period_id: u32,
    expected_period_id: u32,
    timezone_id: TimezoneId,
    location_label_index_map: &IntHashMap<LocationId, LocationPeriodIds>,
    ...
    let location_period_ids: &LocationPeriodIds = match location_label_index_map.get(&global_location_id) {
        None => {
    ...
    let location_label_cache_index: LocationLabelCacheIndex = match location_period_ids
        .location_label_cache_index_map.get(&global_label_id) {
        None => {
    ...
    return get_location_label_rankings_with_cache_indexes(
...
#[inline]
fn get_location_label_rankings_by_location_cache_index_and_global_label_id(
    current_period_id: u32,
    expected_period_id: u32,
    timezone_id: TimezoneId,
    location_label_index_map: &IntHashMap<LocationId, LocationPeriodIds>,
    ...
    = location_label_index_map.get(&(location_cache_index as u64)).unwrap();

    let location_label_cache_index: u32 = match location_period_ids
        .location_label_cache_index_map.get(&global_label_id) {
        None => {
            return codes::INVALID_GLOBAL_CATEGORY_ID_RESPONSE.to_vec();
        }
...
// .get(timezone_id as usize).unwrap().get(location_cache_index as usize).unwrap();
    ...
    return get_location_label_rankings_with_label_cache_index(
        first_record_index as usize, location_label_cache_index,
        &location_poll_rankings, max_poll_number_bytes);
}

#[inline]
fn get_location_label_rankings_by_cache_indexes(
    current_period_id: u32,
    expected_period_id: u32,
    timezone_id: TimezoneId,
    given_period_location_poll_rankings: &Vec<Vec<LocationPollRankings>>,
    ...
    let location_label_vote_counts: &Vec<VoteCount>
    = match location_poll_rankings.label_locations.get(location_label_cache_index as usize) {
        None => {
            return codes::INVALID_CATEGORY_CACHE_INDEX_RESPONSE.to_vec();
        }
        Some(location_label_vote_counts) => {
            location_label_vote_counts
        }
    };

    let first_record_index = PAGE_SIZE * block_index;

    return get_location_label_rankings(
        first_record_index as usize, location_label_vote_counts,
        max_poll_number_bytes);
}

#[inline]
fn get_location_label_rankings_with_cache_indexes(
    ...
    = location_poll_rankings.label_locations.get(label_cache_index as usize).unwrap();
...
#[inline]
fn get_location_label_rankings_with_label_cache_index(
    first_record_index: usize,
    label_cache_index: LabelCacheIndex,
    location_poll_rankings: &LocationPollRankings,
    max_poll_number_bytes: u8,
...
#[inline]
fn get_location_label_rankings(
    first_record_index: usize,
    location_label_vote_counts: &Vec<VoteCount>,
    max_poll_number_bytes: u8,
) -> Vec<u8> {
    match max_poll_number_bytes {
        3 => {
            ...
            return get_3_byte_recent_polls(location_label_vote_counts, first_record_index as usize, response);
        }
        4 => {
            let mut response: Vec<u8> = Vec::with_capacity(INITIAL_RESPONSE_VECTOR_SIZE_4_POLL_BYTES as usize);;
            response.push(0b00000100);

            return get_4_byte_recent_polls(location_label_vote_counts, first_record_index as usize, response);
        }
        5 => {
            let mut response: Vec<u8> = Vec::with_capacity(INITIAL_RESPONSE_VECTOR_SIZE_5_POLL_BYTES as usize);;
            response.push(0b00000101);

            return get_5_byte_recent_polls(location_label_vote_counts, first_record_index as usize, response);
        }
        6 => {
            let mut response: Vec<u8> = Vec::with_capacity(INITIAL_RESPONSE_VECTOR_SIZE_6_POLL_BYTES as usize);;
            response.push(0b00000110);

            return get_6_byte_recent_polls(location_label_vote_counts, first_record_index as usize, response);
        }
        7 => {
            let mut response: Vec<u8> = Vec::with_capacity(INITIAL_RESPONSE_VECTOR_SIZE_7_POLL_BYTES as usize);;
            response.push(0b00000111);

            return get_7_byte_recent_polls(location_label_vote_counts, first_record_index as usize, response);
        }
        8 => {
            let mut response: Vec<u8> = Vec::with_capacity(INITIAL_RESPONSE_VECTOR_SIZE_8_POLL_BYTES as usize);;
            response.push(0b00000000);

            return get_8_byte_recent_polls(location_label_vote_counts, first_record_index as usize, response);
        }
        2 => {
            let mut response: Vec<u8> = Vec::with_capacity(INITIAL_RESPONSE_VECTOR_SIZE_2_POLL_BYTES as usize);;
            response.push(0b00000010);

            return get_2_byte_recent_polls(location_label_vote_counts, first_record_index as usize, response);
        }
        _ => {
            panic!("Unexpected number of bytes {}", max_poll_number_bytes)
        }
